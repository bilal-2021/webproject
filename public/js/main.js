...
const getInfo = async(event)=>{
    ...
    if(cityVal === ""){
        ...
        try{
        let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=58e5f2bfc874fcc8362ebd10c95c19aa`;
        ...
        // Conditiion to check sunny or cloudy
        if(tempMood == "Clear"){
